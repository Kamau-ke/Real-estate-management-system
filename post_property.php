...
//    print_r($_FILES);
   ...
   $image_02_type= $_FILES['image_02']['type'];
   $image_02_tmp_name= $_FILES['image_02']['tmp_name'];
   $image_02_size = $_FILES['image_02']['size'];;
   // $img_error = $_FILES['fileToUpload']['error'];

   
   $image_02_folder = 'uploaded_files/'.$image_02;
   ...
   $image_03_type = $_FILES['image_03']['type'];
  
   $image_03_tmp_name = $_FILES['image_03']['tmp_name'];
   $image_03_size = $_FILES['image_03']['size'];
   $image_03_folder = 'uploaded_files/'.$image_03;
   ...
   $image_01_type = $_FILES['image_01']['type'];
   $image_01_tmp_name = $_FILES['image_01']['tmp_name'];
   $image_01_size = $_FILES['image_01']['size'];
   $image_01_folder = 'uploaded_files/'.$image_01;
   ...
   if($image_01_size > 2000000){
      ...
      $insert_property_query ="INSERT INTO `property`(user_id, property_name, address, price, type, offer, status, furnished, deposite, bedroom, bathroom, balcony, carpet, age, total_floors, room_floor, lift, security_guard, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES('$user_id', '$property_name', '$address', '$price', '$type', '$offer', '$status', '$furnished', '$deposite', '$bedroom', '$bathroom', '$balcony', '$carpet', '$age', '$total_floors', '$room_floor', '$lift', '$security_guard', '$play_ground', '$garden', '$water_supply', '$power_backup', '$parking_area',' $gym', '$shopping_mall', '$hospital', '$school',' $market_area', '$image_01', '$image_02', '$image_03', '$image_04', '$image_05', '$description')" or die($con->errorss);
      
      $insert_property_res=$conn->query($insert_property_query) or die($conn->error_list);
      if ($insert_property_res) {
