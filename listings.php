...
<section class="listings">
   ...
   <div class="box-container">
      <?php
         $total_images = 0;
         $select_properties_query ="SELECT * FROM `property` ORDER BY date DESC";
         ...
         if($select_properties_res){
            ...
            $select_saved_query ="SELECT * FROM `saved` WHERE property_id = '$fetch_property_id' and user_id = ' $user_id'";
