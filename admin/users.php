...
<section class="grid">
   ...
   <?php
         ...
         $select_users_res=$conn->query( $select_users_query)or die($conn->error);
      
      if($select_users_res){
         while($fetch_users = $select_users_res->fetch_assoc()){

            $count_property_query = "SELECT * FROM property" or die($conn->error);
            $count_property_res=$conn->query($count_property_query) or die($conn->error);
    
            // if ($count_property_res) {
            //   while (   $total_properties =$count_property_res->fetch_assoc() ) {
            //  echo "<pre>";
   ...
   <div class="box">
      ...
      <p>number : <a href="tel:<?php echo $fetch_users['number']; ?>"><?php echo $fetch_users['number']; ?></a></p>
      <p>email : <a href="mailto:<?php  echo $fetch_users['email']; ?>"><?php echo $fetch_users['email']; ?></a></p>
      <!-- <p>properties listed : <span><?php echo $total_properties['id']; ?></span></p> -->
